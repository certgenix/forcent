...
import { Check, ArrowLeft, Clock, Users, TrendingUp, Wrench, Calendar, FileText, Bell, Star, MessageSquare, Phone, Truck, ClipboardCheck, Timer } from 'lucide-react';
...
const problems = [
  ...
  'No follow-up on open estimates',
  'Scheduling conflicts',
  'Unreliable customer communication'
];

const solutions = [
  { icon: FileText, text: 'Quotes sent instantly' },
  { icon: Bell, text: 'Follow-ups handled automatically' },
  { icon: Calendar, text: 'Jobs scheduled without friction' },
  { icon: Timer, text: 'Technician reminders sent on time' },
  { icon: Truck, text: 'Customer updates delivered as work progresses' },
  { icon: Star, text: 'Reviews requested automatically' }
];

const outcomes = [
  { metric: '25–50%', label: 'More booked jobs' },
  { metric: 'Faster', label: 'Response time' },
  { metric: 'Better', label: 'Communication' },
  { metric: 'Fewer', label: 'Scheduling issues' }
];

const supports = ['HVAC', 'Plumbing', 'Electrical', 'Landscaping', 'Cleaning', 'Contracting & Renovations'];
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-20">
          ...
          <div className="max-w-4xl mb-16">
            <div className="flex items-center gap-3 mb-6">
              ...
              <Badge variant="secondary" className="text-sm">Trades & Home Services</Badge>
            </div>
            
            <h1 className="text-4xl lg:text-[56px] font-bold text-foreground leading-tight mb-6" data-testid="text-trades-headline">
              Automate Jobs, Quotes, Scheduling, and Customer Communication
            </h1>
            <p className="text-lg text-muted-foreground leading-relaxed" data-testid="text-trades-subheadline">
              We help service businesses win more jobs by automating follow-ups, reminders, and real-time updates.
            </p>
          </div>
