...
import { Check, ArrowLeft, Clock, Users, TrendingUp, Utensils, Calendar, FileText, Bell, Star, MessageSquare, Gift, ShoppingBag, Heart, Package, Repeat } from 'lucide-react';
...
const solutions = [
  { icon: Calendar, text: 'Reservations and confirmations automated' },
  { icon: Gift, text: 'Personalized promotions sent to customers' },
  { icon: Package, text: 'Inventory alerts generated automatically' },
  { icon: Heart, text: 'Loyalty reminders triggered at the right time' },
  { icon: Star, text: 'Review requests sent after each visit' },
  { icon: Repeat, text: 'Customer re-engagement handled for you' }
];

const outcomes = [
  { metric: 'More', label: 'Repeat customers' },
  { metric: 'Higher', label: 'Bookings' },
  { metric: 'Better', label: 'Customer satisfaction' },
  { metric: 'Less', label: 'Admin work' }
];

const supports = ['Restaurants', 'Cafes', 'Boutiques', 'Spas', 'Salons', 'Small Hotels'];

export default function HospitalityRetail() {
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-20">
          ...
          <div className="max-w-4xl mb-16">
            <div className="flex items-center gap-3 mb-6">
              ...
              <Badge variant="secondary" className="text-sm">Hospitality & Retail</Badge>
            </div>
            
            <h1 className="text-4xl lg:text-[56px] font-bold text-foreground leading-tight mb-6" data-testid="text-hospitality-headline">
              Deliver a Better Guest Experience—Without Adding Staff
            </h1>
            <p className="text-lg text-muted-foreground leading-relaxed" data-testid="text-hospitality-subheadline">
              We automate reservations, loyalty, reviews, and customer engagement so your business 
              runs smoothly and stays top-of-mind.
            </p>
          </div>
          ...
          <div className="bg-gradient-brand rounded-xl p-8 lg:p-12 text-center text-white">
            <h2 className="text-3xl lg:text-[36px] font-bold mb-4" data-testid="text-cta-headline">
              Ready to Delight More Customers?
            </h2>
            <p className="text-lg mb-8 opacity-90 max-w-2xl mx-auto" data-testid="text-cta-subheadline">
              Get a free diagnosis of your operations and see how AI can boost your guest experience.
            </p>
