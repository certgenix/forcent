...
import { ArrowLeft, Clock, TrendingUp, Server, Database, BarChart3, Layers, RefreshCw, Zap } from 'lucide-react';
...
const problems = [
  'Disconnected departments (Sales vs. Finance)',
  'Spreadsheets controlling critical business data',
...
const solutions = [
  { icon: Server, text: 'Enterprise Resource Planning (ERP) implementation' },
  { icon: Database, text: 'CRM systems that unify your customer data' },
  { icon: BarChart3, text: 'Business intelligence and reporting dashboards' },
  { icon: Layers, text: 'System integrations across all departments' },
  { icon: RefreshCw, text: 'Process automation and workflow optimization' },
  { icon: Zap, text: 'Real-time data synchronization' }
];

const outcomes = [
  { metric: 'Unified', label: 'Data across departments' },
  { metric: 'Real-time', label: 'Business visibility' },
  { metric: 'Automated', label: 'Manual processes' },
  { metric: 'Smarter', label: 'Decision making' }
];

const supports = ['ERP Implementation', 'CRM Systems', 'Business Intelligence', 'Process Automation', 'Data Migration', 'Change Management'];
      ...
      <section className="py-20 lg:py-32">
        <div className="max-w-7xl mx-auto px-6 lg:px-20">
          ...
          <div className="max-w-4xl mb-16">
            ...
            <h1 className="text-4xl lg:text-[56px] font-bold text-foreground leading-tight mb-6" data-testid="text-digital-headline">
              Transform Chaos Into Intelligence.
            </h1>
            <p className="text-lg text-muted-foreground leading-relaxed" data-testid="text-digital-subheadline">
              Modernize your operations without disrupting your business. We replace disconnected spreadsheets and manual work with integrated Enterprise Resource Planning (ERP) and CRM systems that drive decision-making.
            </p>
          </div>
          ...
          <div className="bg-gradient-brand rounded-xl p-8 lg:p-12 text-center text-white">
            ...
            <p className="text-lg mb-8 opacity-90 max-w-2xl mx-auto" data-testid="text-cta-subheadline">
              Get a free assessment of your current systems and see how digital transformation can drive growth.
            </p>
