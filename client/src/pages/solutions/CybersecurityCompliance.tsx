...
import { ArrowLeft, Clock, TrendingUp, Shield, Lock, Globe, FileCheck, AlertTriangle, Eye } from 'lucide-react';
...
const problems = [
  '"We operate in multiple countries with different regulations"',
  'Unsure if we meet SOC 2, HIPAA, or ISO requirements',
  'No visibility into security vulnerabilities',
  'Fear of data breaches and ransomware attacks',
  'Compliance audits causing business disruption'
];

const solutions = [
  { icon: Globe, text: 'Dual-market compliance expertise (Canada, Saudi Arabia, global)' },
  { icon: FileCheck, text: 'SOC 2, HIPAA, ISO 27001, and PDPL readiness' },
  { icon: Shield, text: 'Threat protection for email, cloud, and devices' },
  { icon: Lock, text: 'Private AI environments for sensitive data' },
  { icon: Eye, text: 'Security monitoring and incident response' },
  { icon: AlertTriangle, text: 'Vulnerability assessments and penetration testing' }
];

const outcomes = [
  { metric: 'Zero', label: 'Compliance gaps' },
  { metric: 'Protected', label: 'Across borders' },
  { metric: 'Trusted', label: 'By enterprise clients' },
  { metric: 'Secure', label: 'AI environments' }
];

const supports = ['SOC 2', 'HIPAA', 'ISO 27001', 'PDPL', 'PIPEDA', 'GDPR'];
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-20">
          ...
          <AnimatedSection className="max-w-4xl mb-16">
            <div className="flex items-center gap-3 mb-6">
              ...
              <Badge variant="secondary" className="text-sm">Cybersecurity & Compliance</Badge>
            </div>
            
            <h1 className="text-4xl lg:text-[56px] font-bold text-foreground leading-tight mb-6" data-testid="text-cybersecurity-headline">
              Global Standards. Local Compliance.
            </h1>
            <p className="text-lg text-muted-foreground leading-relaxed" data-testid="text-cybersecurity-subheadline">
              We secure businesses operating across borders. Whether you are a Canadian firm protecting client privacy or a Saudi enterprise meeting national mandates, we provide the dual-market expertise to keep you compliant and secure.
            </p>
          </AnimatedSection>
          ...
          <ScaleIn delay={0.4}>
            <div className="bg-gradient-brand rounded-xl p-8 lg:p-12 text-center text-white">
              ...
              <p className="text-lg mb-8 opacity-90 max-w-2xl mx-auto" data-testid="text-cta-subheadline">
                Get a free security assessment and compliance gap analysis to understand your risk exposure.
              </p>
